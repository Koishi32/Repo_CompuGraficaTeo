...
int main()
{
	...
	*/
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Practica 1 Alejandro Ivan", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        // Background color // Se utiliza el modelo RGB R rojo, G verde, B azul, Alpha
		...
		//glortho(xizq,xdermy,yinf,ysup,zmin,zmax)
		glBindVertexArray(0);
		glUseProgram(0);
